...
<div class="container mx-auto p-8">
    <?php if (isset($_GET['success']) && $_GET['success'] === 'fiche_attribuee'): ?>
        <div class="bg-green-500 text-white px-4 py-2 rounded-md text-center mb-4">
            La fiche a été attribuée avec succès !
        </div>
    <?php endif; ?>
    ...
    <div class="mt-8 bg-white shadow-md rounded-lg p-6">
        ...
        <?php if (isset($_GET['success']) && $_GET['success'] === 'fiche_desattribuee'): ?>
            <div class="bg-yellow-500 text-white px-4 py-2 rounded-md text-center mb-4">
                L'attribution de la fiche a été retirée avec succès !
            </div>
        <?php endif; ?>
